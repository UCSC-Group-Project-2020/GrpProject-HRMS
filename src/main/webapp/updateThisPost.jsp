            ...
            <tr>
                ...
                <tr>
                    <th class="image">
                        ...
                        <label for="<%=j%>"><img name="img<%=j%>" src="data:image/jpg;base64,<%=imgs[j]%>" width="400" height="300" onclick="remImage(this)"/></label><br>
                        <input type="checkbox" id="<%=j+1%>" value="<%=imgIds[j+1]%>" hidden/><br>
                        <label for="<%=j+1%>"><img name="img<%=j+1%>" src="data:image/jpg;base64,<%=imgs[j+1]%>" width="400" height="300" onclick="remImage(this)"/></label><br>
                    </th>
                </tr>
                <%}}
                else{%>
                <tr>
                    <th class="image">
                        ...
                        <label for="0"><img name="img0" src="data:image/jpg;base64,<%=imgs[0]%>" width="400" height="300" onclick="remImage(this)"/></label><br>
                    </th>
                </tr>
