  ...
  %>
    ...
    <div class="post">
      <table id="post_table">
        ...
        <tr>
        <tr>
          <th class="name"><input type="radio" id="post<%=p%>" name="post" value="<%=pId%>" onclick="executeForm()" hidden><label for="post<%=p%>"><%=rs.getString("firstName")%> <%=rs.getString("lastName")%></label></th>
        </tr>
        <tr>
